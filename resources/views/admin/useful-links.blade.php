...
@section('admin-content')
    ...
    <div class="mt-4">
        ...
        <table class="table table-striped table-hover table-bordered" style="table-layout: fixed;" id="datatable">
            <thead>
                <tr>
                    <th width="50" scope="col">ID</th>
                    <th width="200" scope="col">BAŞLIK</th>
                    <th scope="col">URL</th>
                    <th scope="col">AÇIKLAMA</th>
                    <th width="200" scope="col">İŞLEMLER</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-truncate">
                            <button type="button" class="btn btn-dark" data-bs-toggle="modal"
                                data-bs-target="#update{{ $link->id }}">
                                Güncelle
                            </button>
                            <a href="{{ route('delete.useful-links', $link->id) }}"
                                onclick="return confirm('Linki Silmek İstediğinize Emin misiniz?');"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label>Başlık</label>
                                            <input required type="text" value="{{ $link->title }}" class="form-control"
                                                name="title">
                                        </div>
                                        <div class="mb-3">
                                            <label>Url</label>
                                            <input required type="text" value="{{ $link->url }}" class="form-control"
                                                name="url">
                                        </div>
                                        <div class="mb-3">
                                            <label>Açıklama</label>
                                            <input required type="text" value="{{ $link->description }}"
