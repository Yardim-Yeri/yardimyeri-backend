...
<form action="{{ route('update.admin-demand',$data->id) }}" method="POST">
    ...
    <div class="card">
        <div class="card-header"><h1>Talep Güncelle</h1></div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="tel" value="{{ $data->tel }}">
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="ihtiyac_turu_detayi" value="{{ $data->ihtiyac_turu_detayi }}">
                </div>
    
                <div class="col-md-4 mb-3">
                    <label class="form-label">Kaç Kişinin İhtiyacı Var</label>
                    <input type="number" class="form-control" id="name" name="kac_kisilik" value="{{ $data->kac_kisilik }}">
                </div>
